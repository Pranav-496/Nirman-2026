    ...
    <div className="flex items-center justify-center min-h-[80vh] px-4 animate-fade-in">
      <div className="card w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-fg">Register Admin</h1>
          <p className="text-sm text-fg-3 mt-1">Create an AuthentiFy secure account</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-bg px-2 text-fg-3 uppercase tracking-wider">Or register with email</span>
          </div>
        </div>
